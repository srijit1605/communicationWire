    ...
    <div className={styles.sectionAlignment}>
      ...
      <Container>
        <Row>
          ...
          <div className={styles.articleImageDiv}  style={{background:`url(${articles[0].img})`, backgroundSize:'cover'}}></div>
      ...
      <div className={styles.detailsAlignment}>
        ...
        <p className={styles.readFull}>Read Full article </p>
          ...
          <Col className={styles.colStyle}>
          <SnippetNews articles={articles.slice(1,5)} fulWidth={true}/>
          </Col>
        </Row>
      </Container>
