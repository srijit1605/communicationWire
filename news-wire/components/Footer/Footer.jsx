...
const Footer = () => {
  return (
    <div>
      <div style={{display: 'none'}}>if this is the only push today, then it kind of feels like cheating</div>
      ...
      <a href="https://www.flaticon.com/free-icons/trending-topic" title="trending topic icons">Trending topic icons created by Freepik - Flaticon</a>
      <a href="https://www.flaticon.com/free-icons/calendar" title="calendar icons">Calendar icons created by Freepik - Flaticon</a>
      <a href="https://www.flaticon.com/free-icons/latest" title="latest icons">Latest icons created by Komar Dews - Flaticon</a>
    </div>
  )
}
