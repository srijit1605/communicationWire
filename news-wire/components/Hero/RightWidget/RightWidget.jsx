    ...
    return (
        <div className={styles.widgetStyle}>
            <div className={styles.tabButtons}>
                <div className={styles.tabButton} style={{borderBottom: trending? '0px solid black' : '2px solid black'}} onClick={()=>{setTrending(false)}}>
                    <img src='/static/img/clock.png' width={14} alt='latest' title='latest'/>
                    <h5 className={styles.tabButtonText}>Latest News</h5>
                </div>
                <div className={styles.tabButton}  style={{borderBottom: trending? '2px solid black' : '0px solid black'}} onClick={()=>{setTrending(true)}}>
